%Dataset = imageDatastore('gelecek datasetin konumu(dataaset location)', 'IncludeSubfolders', true, 'LabelSource', 'foldernames');
...
Training_Options = trainingOptions('sgdm',...
    ...
    'MaxEpochs', 20,...%buranın degeri daha fazla artarsa ysa egitimi uzun surer
...
save googlenet_2.mat; % Datalara gore egittimiz kodu kayıt eder
